...
startmeup:	
			...
			;msg81
			ldi temp, low(msg81 << 1)
			pushIT(temp)
			ldi temp, high(msg81 << 1)
			pushIT(temp)
			...
			;msg82
			ldi temp, low(msg82 << 1)
			pushIT(temp)
			ldi temp, high(msg82 << 1)
			pushIT(temp)
			...
			;msg83
			ldi temp, low(msg83 << 1)
			pushIT(temp)
			ldi temp, high(msg83 << 1)
			pushIT(temp)
			...
			;msg84
			ldi temp, low(msg84 << 1)
			pushIT(temp)
			ldi temp, high(msg84 << 1)
			pushIT(temp)
			...
			;msg85
			ldi temp, low(msg85 << 1)
			pushIT(temp)
			ldi temp, high(msg85 << 1)
			pushIT(temp)
			ldi temp, low(lcd_msg05)
			pushIT(temp)
			ldi temp, high(lcd_msg05)
			pushIT(temp)
			rcall msgs
			
			;msg86
			ldi temp, low(msg86 << 1)
			pushIT(temp)
			ldi temp, high(msg86 << 1)
			pushIT(temp)
			ldi temp, low(lcd_msg06)
			pushIT(temp)
			ldi temp, high(lcd_msg06)
			pushIT(temp)
			rcall msgs
			
			;msg87
			ldi temp, low(msg87 << 1)
			pushIT(temp)
			ldi temp, high(msg87 << 1)
			pushIT(temp)
			ldi temp, low(lcd_msg07)
			pushIT(temp)
			ldi temp, high(lcd_msg07)
			pushIT(temp)
			rcall msgs
			
			;msg85
			ldi temp, low(msg88 << 1)
			pushIT(temp)
			ldi temp, high(msg88 << 1)
			pushIT(temp)
			ldi temp, low(lcd_msg08)
			pushIT(temp)
			ldi temp, high(lcd_msg08)
			pushIT(temp)
			rcall msgs
			...
			ldi temp, high(msg81 << 1)
			pushIT(temp)
			ldi temp, low(lcd_msg09)
			pushIT(temp)
			ldi temp, high(lcd_msg09)
			pushIT(temp)
			rcall reverse_msgs		
			...
			ldi temp, high(msg82 << 1)
			pushIT(temp)
			ldi temp, low(lcd_msg10)
			pushIT(temp)
			ldi temp, high(lcd_msg10)
			pushIT(temp)
			rcall reverse_msgs
			...
			ldi temp, high(msg83 << 1)
			pushIT(temp)
			ldi temp, low(lcd_msg11)
			pushIT(temp)
			ldi temp, high(lcd_msg11)
			pushIT(temp)
			rcall reverse_msgs
			...
			ldi temp, high(msg84 << 1)
			pushIT(temp)
			ldi temp, low(lcd_msg12)
			pushIT(temp)
			ldi temp, high(lcd_msg12)
			pushIT(temp)
			rcall reverse_msgs	
			...
			ldi temp, high(msg85 << 1)
			pushIT(temp)
			ldi temp, low(lcd_msg13)
			pushIT(temp)
			ldi temp, high(lcd_msg13)
			pushIT(temp)
			rcall reverse_msgs
			...
			ldi temp, high(msg86 << 1)
			pushIT(temp)
			ldi temp, low(lcd_msg14)
			pushIT(temp)
			ldi temp, high(lcd_msg14)
			pushIT(temp)
			rcall reverse_msgs	
			...
			ldi temp, high(msg87 << 1)
			pushIT(temp)
			ldi temp, low(lcd_msg15)
			pushIT(temp)
			ldi temp, high(lcd_msg15)
			pushIT(temp)
			rcall reverse_msgs	
			...
			ldi temp, high(msg88 << 1)
			pushIT(temp)
			ldi temp, low(lcd_msg16)
			pushIT(temp)
			ldi temp, high(lcd_msg16)
			pushIT(temp)
			rcall reverse_msgs	
...
; msg21: .db "An old pond. ", 0
; msg22: .db "Frog jump. Plop! ", 0
